...
// Registered here, at module load, so it's in place before any model file's
// mongoose.model() call compiles its schema — every route requires this
// file first (to get connectDB), so this reliably covers every model.
// Diagnostic only; see lib/mongoTiming.js and lib/perfMonitor.js.
mongoose.plugin(require("./mongoTiming"));
