...
const { leadVariables, renderText, renderEmail, unsubscribeUrl } = require("./render");
...
module.exports = { startCampaign, processCampaign, runDueCampaigns, applyWhatsAppStatus, applyWhatsAppInbound, applyEmailEvent, inQuietHours, senderFor };
