...
// admin may perform — not even a company's own admin. Mirrors the
// super-admin branch of requireCompanyMemberOrSuperAdminView above
// (validates ?companyId=, scopes the request to it), but rejects every
// other role outright instead of falling back to req.session.companyId.
