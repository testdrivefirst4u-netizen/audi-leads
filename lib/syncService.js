...
// SyncLog entry every run. The dashboard picks up changes by polling
// /api/sync-status and /api/leads rather than a server push, so this works
// the same whether triggered by local node-cron or a Vercel Cron hit.
