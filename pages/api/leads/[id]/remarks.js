...
async function handler(req, res) {
  ...
  // /api/leads.js caches the Overdue/Due Today tab counts for a few
  // seconds — without this, a lead just resolved by this remark could still
  // show up there until that cache expires, looking like the auto-complete
  // didn't work.
